...
function createGrid() {
    ...
    function updateList() {
        ...
        price.textContent = (50000 * selectedData.length).toLocaleString();
...
function pricombo() {
    ...
    pricecombo.textContent = totalPriceOfCombo.toLocaleString();
    totalPriceFull();
}

function totalPriceFull() {
    var total = document.getElementById("totalpricefull");
    total.textContent = (priceseat + totalPriceOfCombo).toLocaleString();
}
function Thanhtoan() {
    const thanhtoan = {
...
function ShowBill() {
    ...
    pricecheckcount.innerHTML = (da.priceseat).toLocaleString();
    pricecombocheckcount.innerHTML = (da.pricecombo).toLocaleString();
    selectcombocheckcount.innerHTML= (da.listcombo);
    totalpricefullcheckcount.innerHTML = (da.pricebill).toLocaleString();
